...
import { setUser } from "../../redux/userSlice"; // Import userSlice actions
import { registerUser } from "../../redux/authSlice"; // Import authSlice actions
...
const LoginRegister = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // Dispatch the registerUser async action to handle the registration
      ...
      dispatch(setUser(res.payload)); // Store token in Redux
